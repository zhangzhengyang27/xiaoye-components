...
const gallery = [
  { title: "封面 1", accent: "var(--xy-brand)" },
  { title: "封面 2", accent: "var(--xy-success)" },
  { title: "封面 3", accent: "var(--xy-warning)" },
  { title: "封面 4", accent: "var(--xy-info)" }
] as const;
</script>
...
<template>
  ...
  >
    <xy-carousel-item v-for="item in gallery" :key="item.title">
      <div class="demo-carousel-gallery" :style="{ '--demo-carousel-accent': item.accent }">
